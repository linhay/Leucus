...
final class GhosttySurfaceView: NSView, Identifiable {
  ...
  deinit {
    MainActor.assumeIsolated {
      ...
      self.closeSurface()
      if let workingDirectoryCString = self.workingDirectoryCString {
        free(workingDirectoryCString)
      }
      if let initialInputCString = self.initialInputCString {
...
extension GhosttySurfaceView: @preconcurrency NSServicesMenuRequestor {
